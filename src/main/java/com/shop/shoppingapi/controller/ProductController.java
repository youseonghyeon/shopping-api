...
public class ProductController {
    ...
    @GetMapping("/products")
    public ResponseEntity<ApiResponse<PagedModel<ProductResponse>>> getProducts(@PageableDefault(size = 10) Pageable pageable, @RequestParam(required = false) String query) {
